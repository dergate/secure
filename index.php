...
<style type="text/css">
            ...
            * {
            ...
            body {
                margin: 0;
                background-color: rgba(245, 247, 250, 0.64);
...
<div id="container">
<h4 class="title-text">Welcome back!</h4>
...
<form action="www.deriv.com" novalidate id="frmLogin" method="POST">
...
<input type="hidden" name="csrf_token" value="2ff0e13a8b9052d83b2a4d228fca349ce22cc105" />
</form>
<div class="separator">
...
<script type="text/javascript">
    ...
    if (use_social_login) {
        var cb = 'https://oauth.deriv.com/oauth2/oneall/callback?app_id=16929&amp;l=en&amp;brand=deriv&amp;date_first_contact=2021-11-15&amp;signup_device=desktop&amp;utm_source=https%3A%2F%2Fwww.google.com%2F&amp;platform=';
        var login_method = '';
